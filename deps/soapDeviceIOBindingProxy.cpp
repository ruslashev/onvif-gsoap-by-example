...
int DeviceIOBindingProxy::GetServiceCapabilities(const char *soap_endpoint_url, const char *soap_action, _tmd__GetServiceCapabilities *tmd__GetServiceCapabilities, _tmd__GetServiceCapabilitiesResponse &tmd__GetServiceCapabilitiesResponse)
{
...
int DeviceIOBindingProxy::GetRelayOutputOptions(const char *soap_endpoint_url, const char *soap_action, _tmd__GetRelayOutputOptions *tmd__GetRelayOutputOptions, _tmd__GetRelayOutputOptionsResponse &tmd__GetRelayOutputOptionsResponse)
{
...
int DeviceIOBindingProxy::GetAudioSources(const char *soap_endpoint_url, const char *soap_action, tmd__Get *tmd__GetAudioSources, tmd__GetResponse &tmd__GetAudioSourcesResponse)
{
...
int DeviceIOBindingProxy::GetAudioOutputs(const char *soap_endpoint_url, const char *soap_action, tmd__Get *tmd__GetAudioOutputs, tmd__GetResponse &tmd__GetAudioOutputsResponse)
{
...
int DeviceIOBindingProxy::GetVideoSources(const char *soap_endpoint_url, const char *soap_action, tmd__Get *tmd__GetVideoSources, tmd__GetResponse &tmd__GetVideoSourcesResponse)
{
...
int DeviceIOBindingProxy::GetVideoOutputs(const char *soap_endpoint_url, const char *soap_action, _tmd__GetVideoOutputs *tmd__GetVideoOutputs, _tmd__GetVideoOutputsResponse &tmd__GetVideoOutputsResponse)
{
...
int DeviceIOBindingProxy::GetVideoSourceConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__GetVideoSourceConfiguration *tmd__GetVideoSourceConfiguration, _tmd__GetVideoSourceConfigurationResponse &tmd__GetVideoSourceConfigurationResponse)
{
...
int DeviceIOBindingProxy::GetVideoOutputConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__GetVideoOutputConfiguration *tmd__GetVideoOutputConfiguration, _tmd__GetVideoOutputConfigurationResponse &tmd__GetVideoOutputConfigurationResponse)
{
...
int DeviceIOBindingProxy::GetAudioSourceConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__GetAudioSourceConfiguration *tmd__GetAudioSourceConfiguration, _tmd__GetAudioSourceConfigurationResponse &tmd__GetAudioSourceConfigurationResponse)
{
...
int DeviceIOBindingProxy::GetAudioOutputConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__GetAudioOutputConfiguration *tmd__GetAudioOutputConfiguration, _tmd__GetAudioOutputConfigurationResponse &tmd__GetAudioOutputConfigurationResponse)
{
...
int DeviceIOBindingProxy::SetVideoSourceConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__SetVideoSourceConfiguration *tmd__SetVideoSourceConfiguration, _tmd__SetVideoSourceConfigurationResponse &tmd__SetVideoSourceConfigurationResponse)
{
...
int DeviceIOBindingProxy::SetVideoOutputConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__SetVideoOutputConfiguration *tmd__SetVideoOutputConfiguration, _tmd__SetVideoOutputConfigurationResponse &tmd__SetVideoOutputConfigurationResponse)
{
...
int DeviceIOBindingProxy::SetAudioSourceConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__SetAudioSourceConfiguration *tmd__SetAudioSourceConfiguration, _tmd__SetAudioSourceConfigurationResponse &tmd__SetAudioSourceConfigurationResponse)
{
...
int DeviceIOBindingProxy::SetAudioOutputConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__SetAudioOutputConfiguration *tmd__SetAudioOutputConfiguration, _tmd__SetAudioOutputConfigurationResponse &tmd__SetAudioOutputConfigurationResponse)
{
...
int DeviceIOBindingProxy::GetVideoSourceConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _tmd__GetVideoSourceConfigurationOptions *tmd__GetVideoSourceConfigurationOptions, _tmd__GetVideoSourceConfigurationOptionsResponse &tmd__GetVideoSourceConfigurationOptionsResponse)
{
...
int DeviceIOBindingProxy::GetVideoOutputConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _tmd__GetVideoOutputConfigurationOptions *tmd__GetVideoOutputConfigurationOptions, _tmd__GetVideoOutputConfigurationOptionsResponse &tmd__GetVideoOutputConfigurationOptionsResponse)
{
...
int DeviceIOBindingProxy::GetAudioSourceConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _tmd__GetAudioSourceConfigurationOptions *tmd__GetAudioSourceConfigurationOptions, _tmd__GetAudioSourceConfigurationOptionsResponse &tmd__GetAudioSourceConfigurationOptionsResponse)
{
...
int DeviceIOBindingProxy::GetAudioOutputConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _tmd__GetAudioOutputConfigurationOptions *tmd__GetAudioOutputConfigurationOptions, _tmd__GetAudioOutputConfigurationOptionsResponse &tmd__GetAudioOutputConfigurationOptionsResponse)
{
...
int DeviceIOBindingProxy::GetRelayOutputs(const char *soap_endpoint_url, const char *soap_action, _tds__GetRelayOutputs *tds__GetRelayOutputs, _tds__GetRelayOutputsResponse &tds__GetRelayOutputsResponse)
{
...
int DeviceIOBindingProxy::SetRelayOutputSettings(const char *soap_endpoint_url, const char *soap_action, _tmd__SetRelayOutputSettings *tmd__SetRelayOutputSettings, _tmd__SetRelayOutputSettingsResponse &tmd__SetRelayOutputSettingsResponse)
{
...
int DeviceIOBindingProxy::SetRelayOutputState(const char *soap_endpoint_url, const char *soap_action, _tds__SetRelayOutputState *tds__SetRelayOutputState, _tds__SetRelayOutputStateResponse &tds__SetRelayOutputStateResponse)
{
...
int DeviceIOBindingProxy::GetDigitalInputs(const char *soap_endpoint_url, const char *soap_action, _tmd__GetDigitalInputs *tmd__GetDigitalInputs, _tmd__GetDigitalInputsResponse &tmd__GetDigitalInputsResponse)
{
...
int DeviceIOBindingProxy::GetDigitalInputConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _tmd__GetDigitalInputConfigurationOptions *tmd__GetDigitalInputConfigurationOptions, _tmd__GetDigitalInputConfigurationOptionsResponse &tmd__GetDigitalInputConfigurationOptionsResponse)
{
...
int DeviceIOBindingProxy::SetDigitalInputConfigurations(const char *soap_endpoint_url, const char *soap_action, _tmd__SetDigitalInputConfigurations *tmd__SetDigitalInputConfigurations, _tmd__SetDigitalInputConfigurationsResponse &tmd__SetDigitalInputConfigurationsResponse)
{
...
int DeviceIOBindingProxy::GetSerialPorts(const char *soap_endpoint_url, const char *soap_action, _tmd__GetSerialPorts *tmd__GetSerialPorts, _tmd__GetSerialPortsResponse &tmd__GetSerialPortsResponse)
{
...
int DeviceIOBindingProxy::GetSerialPortConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__GetSerialPortConfiguration *tmd__GetSerialPortConfiguration, _tmd__GetSerialPortConfigurationResponse &tmd__GetSerialPortConfigurationResponse)
{
...
int DeviceIOBindingProxy::SetSerialPortConfiguration(const char *soap_endpoint_url, const char *soap_action, _tmd__SetSerialPortConfiguration *tmd__SetSerialPortConfiguration, _tmd__SetSerialPortConfigurationResponse &tmd__SetSerialPortConfigurationResponse)
{
...
int DeviceIOBindingProxy::GetSerialPortConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _tmd__GetSerialPortConfigurationOptions *tmd__GetSerialPortConfigurationOptions, _tmd__GetSerialPortConfigurationOptionsResponse &tmd__GetSerialPortConfigurationOptionsResponse)
{
...
int DeviceIOBindingProxy::SendReceiveSerialCommand(const char *soap_endpoint_url, const char *soap_action, _tmd__SendReceiveSerialCommand *tmd__SendReceiveSerialCommand, _tmd__SendReceiveSerialCommandResponse &tmd__SendReceiveSerialCommandResponse)
{
