...
int RemoteDiscoveryBindingProxy::Hello(const char *soap_endpoint_url, const char *soap_action, const struct wsdd__HelloType& tdn__Hello, struct wsdd__ResolveType &tdn__HelloResponse)
{
...
int RemoteDiscoveryBindingProxy::Bye(const char *soap_endpoint_url, const char *soap_action, const struct wsdd__ByeType& tdn__Bye, struct wsdd__ResolveType &tdn__ByeResponse)
{
...
int RemoteDiscoveryBindingProxy::Probe(const char *soap_endpoint_url, const char *soap_action, const struct wsdd__ProbeType& tdn__Probe, struct wsdd__ProbeMatchesType &tdn__ProbeResponse)
{
