...
int PTZBindingProxy::GetServiceCapabilities(const char *soap_endpoint_url, const char *soap_action, _tptz__GetServiceCapabilities *tptz__GetServiceCapabilities, _tptz__GetServiceCapabilitiesResponse &tptz__GetServiceCapabilitiesResponse)
{
...
int PTZBindingProxy::GetConfigurations(const char *soap_endpoint_url, const char *soap_action, _tptz__GetConfigurations *tptz__GetConfigurations, _tptz__GetConfigurationsResponse &tptz__GetConfigurationsResponse)
{
...
int PTZBindingProxy::GetPresets(const char *soap_endpoint_url, const char *soap_action, _tptz__GetPresets *tptz__GetPresets, _tptz__GetPresetsResponse &tptz__GetPresetsResponse)
{
...
int PTZBindingProxy::SetPreset(const char *soap_endpoint_url, const char *soap_action, _tptz__SetPreset *tptz__SetPreset, _tptz__SetPresetResponse &tptz__SetPresetResponse)
{
...
int PTZBindingProxy::RemovePreset(const char *soap_endpoint_url, const char *soap_action, _tptz__RemovePreset *tptz__RemovePreset, _tptz__RemovePresetResponse &tptz__RemovePresetResponse)
{
...
int PTZBindingProxy::GotoPreset(const char *soap_endpoint_url, const char *soap_action, _tptz__GotoPreset *tptz__GotoPreset, _tptz__GotoPresetResponse &tptz__GotoPresetResponse)
{
...
int PTZBindingProxy::GetStatus(const char *soap_endpoint_url, const char *soap_action, _tptz__GetStatus *tptz__GetStatus, _tptz__GetStatusResponse &tptz__GetStatusResponse)
{
...
int PTZBindingProxy::GetConfiguration(const char *soap_endpoint_url, const char *soap_action, _tptz__GetConfiguration *tptz__GetConfiguration, _tptz__GetConfigurationResponse &tptz__GetConfigurationResponse)
{
...
int PTZBindingProxy::GetNodes(const char *soap_endpoint_url, const char *soap_action, _tptz__GetNodes *tptz__GetNodes, _tptz__GetNodesResponse &tptz__GetNodesResponse)
{
...
int PTZBindingProxy::GetNode(const char *soap_endpoint_url, const char *soap_action, _tptz__GetNode *tptz__GetNode, _tptz__GetNodeResponse &tptz__GetNodeResponse)
{
...
int PTZBindingProxy::SetConfiguration(const char *soap_endpoint_url, const char *soap_action, _tptz__SetConfiguration *tptz__SetConfiguration, _tptz__SetConfigurationResponse &tptz__SetConfigurationResponse)
{
...
int PTZBindingProxy::GetConfigurationOptions(const char *soap_endpoint_url, const char *soap_action, _tptz__GetConfigurationOptions *tptz__GetConfigurationOptions, _tptz__GetConfigurationOptionsResponse &tptz__GetConfigurationOptionsResponse)
{
...
int PTZBindingProxy::GotoHomePosition(const char *soap_endpoint_url, const char *soap_action, _tptz__GotoHomePosition *tptz__GotoHomePosition, _tptz__GotoHomePositionResponse &tptz__GotoHomePositionResponse)
{
...
int PTZBindingProxy::SetHomePosition(const char *soap_endpoint_url, const char *soap_action, _tptz__SetHomePosition *tptz__SetHomePosition, _tptz__SetHomePositionResponse &tptz__SetHomePositionResponse)
{
...
int PTZBindingProxy::ContinuousMove(const char *soap_endpoint_url, const char *soap_action, _tptz__ContinuousMove *tptz__ContinuousMove, _tptz__ContinuousMoveResponse &tptz__ContinuousMoveResponse)
{
...
int PTZBindingProxy::RelativeMove(const char *soap_endpoint_url, const char *soap_action, _tptz__RelativeMove *tptz__RelativeMove, _tptz__RelativeMoveResponse &tptz__RelativeMoveResponse)
{
...
int PTZBindingProxy::SendAuxiliaryCommand(const char *soap_endpoint_url, const char *soap_action, _tptz__SendAuxiliaryCommand *tptz__SendAuxiliaryCommand, _tptz__SendAuxiliaryCommandResponse &tptz__SendAuxiliaryCommandResponse)
{
...
int PTZBindingProxy::AbsoluteMove(const char *soap_endpoint_url, const char *soap_action, _tptz__AbsoluteMove *tptz__AbsoluteMove, _tptz__AbsoluteMoveResponse &tptz__AbsoluteMoveResponse)
{
...
int PTZBindingProxy::GeoMove(const char *soap_endpoint_url, const char *soap_action, _tptz__GeoMove *tptz__GeoMove, _tptz__GeoMoveResponse &tptz__GeoMoveResponse)
{
...
int PTZBindingProxy::Stop(const char *soap_endpoint_url, const char *soap_action, _tptz__Stop *tptz__Stop, _tptz__StopResponse &tptz__StopResponse)
{
...
int PTZBindingProxy::GetPresetTours(const char *soap_endpoint_url, const char *soap_action, _tptz__GetPresetTours *tptz__GetPresetTours, _tptz__GetPresetToursResponse &tptz__GetPresetToursResponse)
{
...
int PTZBindingProxy::GetPresetTour(const char *soap_endpoint_url, const char *soap_action, _tptz__GetPresetTour *tptz__GetPresetTour, _tptz__GetPresetTourResponse &tptz__GetPresetTourResponse)
{
...
int PTZBindingProxy::GetPresetTourOptions(const char *soap_endpoint_url, const char *soap_action, _tptz__GetPresetTourOptions *tptz__GetPresetTourOptions, _tptz__GetPresetTourOptionsResponse &tptz__GetPresetTourOptionsResponse)
{
...
int PTZBindingProxy::CreatePresetTour(const char *soap_endpoint_url, const char *soap_action, _tptz__CreatePresetTour *tptz__CreatePresetTour, _tptz__CreatePresetTourResponse &tptz__CreatePresetTourResponse)
{
...
int PTZBindingProxy::ModifyPresetTour(const char *soap_endpoint_url, const char *soap_action, _tptz__ModifyPresetTour *tptz__ModifyPresetTour, _tptz__ModifyPresetTourResponse &tptz__ModifyPresetTourResponse)
{
...
int PTZBindingProxy::OperatePresetTour(const char *soap_endpoint_url, const char *soap_action, _tptz__OperatePresetTour *tptz__OperatePresetTour, _tptz__OperatePresetTourResponse &tptz__OperatePresetTourResponse)
{
...
int PTZBindingProxy::RemovePresetTour(const char *soap_endpoint_url, const char *soap_action, _tptz__RemovePresetTour *tptz__RemovePresetTour, _tptz__RemovePresetTourResponse &tptz__RemovePresetTourResponse)
{
...
int PTZBindingProxy::GetCompatibleConfigurations(const char *soap_endpoint_url, const char *soap_action, _tptz__GetCompatibleConfigurations *tptz__GetCompatibleConfigurations, _tptz__GetCompatibleConfigurationsResponse &tptz__GetCompatibleConfigurationsResponse)
{
